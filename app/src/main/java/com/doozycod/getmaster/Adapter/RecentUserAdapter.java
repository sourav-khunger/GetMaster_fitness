...
public class RecentUserAdapter extends RecyclerView.Adapter<RecentUserAdapter.RecyclerHolder> {
    Context context;
    List<RecentUser> list;

    public RecentUserAdapter(Context context, List<RecentUser> list) {
    ...
    @NonNull
    @Override
    public RecentUserAdapter.RecyclerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.user_list_home_recycler, parent, false);
        return new RecyclerHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecentUserAdapter.RecyclerHolder holder, int position) {
